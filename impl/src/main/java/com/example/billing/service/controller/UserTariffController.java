...
public class UserTariffController {
    ...
    @PostMapping
    public ResponseEntity addService(@RequestBody Turn service, @RequestParam Long userId, @RequestParam Long tariffId) {
        return ResponseEntity.ok(userTariffService.addService(service, userId, tariffId));
    }

    @PutMapping
    public ResponseEntity updateService(@RequestBody Turn service, @RequestParam Long userId, @RequestParam Long tariffId) {
